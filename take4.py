...
# ====================== Constants ======================
MODEL_PATH = "crnn_model.pth"  # Updated path
IMAGE_PATH = "test_image.jpg"
ALPHANUMERIC = "0123456789ABCDEFGIJKLMNOPRUVWXZ"
DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")


# ====================== Updated CRNN Model Definition ======================
...
def process_image(image_path, yolo_model, crnn_model):
    try:
        ...
        transform = transforms.Compose([
            transforms.Resize((64, 100)),  # Make sure this matches training input
            transforms.ToTensor(),
...
def main():
    try:
        capture_image()
        yolo_model = YOLO("yolo_model.pt")  # Ensure this is your correct YOLO weights
